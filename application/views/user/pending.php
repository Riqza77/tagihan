    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-8 mb-2">
                <form method="post" class="form-inline" action="<?= base_url('user/pending') ?>">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <?php if ($pk['status']!= 'Pending'): ?>
                          <small class="label bg-blue"><?= $pk['status']; ?></small>  
                        <?php else: ?>
                          <small class="label bg-yellow"><?= $pk['status']; ?></small>
                        <?php endif ?>
                      </td>
                      <td class="text-center">
                        <a href="<?=base_url('user/bayar/'). $pk['id_tagihan'];?>"><button class="btn btn-primary btn-sm">
                        Bayar</button></a>
